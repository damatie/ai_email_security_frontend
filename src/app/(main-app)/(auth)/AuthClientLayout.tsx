...
export default function AuthClientLayout({
  ...
  return (
    <main className="flex flex-row w-full min-h-screen">
      <div className="flex flex-col w-full bg-white px-[65px] pt-[65px] items-center">
        <section className="flex flex-col w-full max-w-[600px]">
          <Image src={mainLogo} alt="Logo" className="object-contain" />
        </section>
        <section className="flex flex-col justify-items-center items-center w-full lg:max-w-[420px] mt-[157px]">
          {children}
        </section>
      </div>
